...
function initVipFloatingWidget() {
  ...
  widget.innerHTML = `
    ...
    <div class="vip-speed-dial-menu" id="vipSpeedDialMenu">
      <a href="https://goo.gl/maps/LuAm1e5uhuU4xMN36?g_st=ac" target="_blank" rel="noopener noreferrer" class="vip-dial-item dial-map" title="موقعنا على الخريطة">
        <span class="dial-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg></span>
        <span class="dial-text">موقعنا على الخريطة</span>
      </a>
      <a href="tel:+966553925444" class="vip-dial-item dial-phone" title="اتصل الآن مباشر 0553925444">
        ...
        <span class="dial-text">اتصل الآن: <span dir="ltr">+966553925444</span></span>
      </a>
